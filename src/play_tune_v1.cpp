...
class PlayTuneV1Plugin : public mavros::plugin::Plugin {
 public:
  explicit PlayTuneV1Plugin(mavros::plugin::UASPtr uas_)
      : Plugin(uas_, "play_tune_v1") {
    sound_tune_sub_ = node->create_subscription<std_msgs::msg::String>(
        "~/tune", 10,
        std::bind(&PlayTuneV1Plugin::onTuneData, this, std::placeholders::_1));
  }
 ...
 private:
  ...
  rclcpp::Subscription<std_msgs::msg::String>::SharedPtr sound_tune_sub_{
      nullptr};
};
